...
SITE = "fstakesukyan" #same as url_pattern
WAIT = 12
COOKIES = False
GROUP = "fstake-sukyan"
...
class Manga:
    ...
    URL_PATTERN = r"^https?://(www\.)?capibaratraductor.com/fstakesukyan"
    ...
    def set_client(self, cookies, user_agent):
        ...
        self.headers={"User-Agent": self.user_agent, 
                "Referer": "https://capibaratraductor.com/fstakesukyan",
                "x-organization": "fstakesukyan"}
    ...
    def get_chapters(self):
        ...
        chapter_headers['Referer'] = f'https://capibaratraductor.com/fstakesukyan/manga/{self.url}'
